...
Batchelor.prototype.pause = function() {
  return this.changePermStream.pause();
};

Batchelor.prototype.resume = function() {
  return this.changePermStream.resume();
};
...
function datafileName(tableName, basePath) {
  return basePath + '/' + tableName + '.' + Math.floor(new Date().getTime() / 1000) + '.data';
};
